...
public class Spotify1 {
	...
	/*2*/ String[] turnOffLem = {"volume","increase",};
	/*3*/ String[] setVolumeDownLem = {"down","decrease"};
	/*4 / String[] isOff = {"off"," turn off"}
	...
	public int lemLayer2(String[][] sentence){
		...
		for(int i=0; i<sentence.length;i++){
			...
			for(int k=0; k<setPreviousSongLem.length;k++){
					if(sentence[i][0].toLowerCase().contains((setPreviousSongLem[k].toLowerCase()))){
					counter[5]++;		
					}
			}
		...
		case 1: //System.out.println("Spotify method isPlaying");
				this.turnOn();
				break;
		case 2: //System.out.println("Spotify method setVolumeUp");
				this.turnOff();
				break;
		case 3: //System.out.println("Spotify method setVolumeDown");
				this.setVolumeDown();
				break;
		case 4: //System.out.println("Spotify method setNextSong");
				this.setNextSong();
				break;
		case 5: //System.out.println("Spotify method setPreviousSong");
				this.setPreviousSong();
				break;
		case 6: //System.out.println("Spotify method isOff");
				//this.isOff();
				break;
